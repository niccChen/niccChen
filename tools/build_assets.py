...
def build_banner():
    ...
    frames[0].save(ASSETS/"banner-banff-static.png",optimize=True)
    ...
    indexed[0].save(ASSETS/"banner-banff.gif",save_all=True,append_images=indexed[1:],duration=100,loop=0,optimize=True,disposal=1)
    ...
    print("Banner:", (ASSETS/"banner-banff.gif").stat().st_size, "bytes;",len(frames),"frames")
...
def build_readme(widths):
  ...
  <img src="./assets/banner-banff.gif" alt="Yiyun Chen — Machine Learning & Applied AI — Emory University. Banff-inspired pixel mountains, a turquoise lake, and pine trees." width="100%">
</picture>
